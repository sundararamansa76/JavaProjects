...
insert into Student(id, name,created_date, last_updated_date) values(2004, 'Balarama', sysdate(),sysdate() );
insert into Student(id, name,created_date, last_updated_date) values(2005, 'Krsna', sysdate(),sysdate() );
insert into Student(id, name,created_date, last_updated_date) values(2006, 'Radhe', sysdate(),sysdate() );
...
insert into Review(id, rating,description, created_date, last_updated_date) values(4001, '4','good', sysdate(),sysdate() );
insert into Review(id, rating,description, created_date, last_updated_date) values(4002, '5','Super', sysdate(),sysdate() );